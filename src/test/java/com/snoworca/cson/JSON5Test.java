...
public class JSON5Test {
    ...
    public void testKeyComment() {
        CSONObject csonObject = new CSONObject("{ \n" +
                "/* 코멘트입니다. */\n //222 \n " +
                " key: /* 값 코멘트 */ \"value\", key2: \"val/* ok */ue2\", 'key3' /*이상한 코멘트*/: // 값 앞 코멘트 \n 'value3' // 값 뒤 코멘트 \n /*123*/,  \n /*123*/ } /* 꼬리 다음 코멘트 */"   );

        assertEquals("코멘트입니다.\n222",csonObject.getKeyComment("key"));
        assertEquals("값 코멘트",csonObject.getValueComment("key").getAfterKey());
        ...
        assertEquals("이상한 코멘트",csonObject.getKeyComment("key3"));
        ...
        assertEquals("값 뒤 코멘트\n123",csonObject.getTailCommentObject());
